    ...
    <footer className="footer">
      <div className="container">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              ...
              <a href={site?.socials?.linkedin} target="_blank" rel="noreferrer" aria-label="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14zM8.3 18.3V10H5.7v8.3h2.6zM7 8.8a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm11.3 9.5v-4.7c0-2.5-1.3-3.7-3.1-3.7-1.4 0-2.1.8-2.4 1.4V10h-2.6v8.3h2.6v-4.6c0-1.2.8-1.9 1.7-1.9.9 0 1.4.6 1.4 1.9v4.6h2.4z"/></svg>
              </a>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <span>© {new Date().getFullYear()} {site?.brandName || 'Digital Whopper'}. All rights reserved.</span>
